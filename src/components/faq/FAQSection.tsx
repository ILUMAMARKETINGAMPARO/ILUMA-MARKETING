    ...
    <div className="space-y-6">
      ...
      <div className="text-center">
        ...
        <p className="text-white/70 max-w-2xl mx-auto font-['Montserrat']">
          {language === 'fr' && 'Trouvez rapidement les réponses à vos questions sur nos services IA-first, SEO local et solutions Lovable™'}
          {language === 'en' && 'Quickly find answers to your questions about our AI-first services, local SEO and Lovable™ solutions'}
          {language === 'es' && 'Encuentra rápidamente respuestas a tus preguntas sobre nuestros servicios IA-first, SEO local y soluciones Lovable™'}
        </p>
      </div>
            ...
            {showSearch && (
              <div className="flex-1">
                <div className="relative">
                  ...
                  <Input
                    placeholder={
                      language === 'fr' ? 'Rechercher une question...' :
      ...
      {filteredFAQs.length === 0 && (
        <Card className="glass-effect border-white/20 p-8 text-center">
          ...
          <p className="text-white/60 font-['Montserrat']">
            {language === 'fr' && 'Aucune question trouvée pour ces critères.'}
            {language === 'en' && 'No questions found for these criteria.'}
            {language === 'es' && 'No se encontraron preguntas para estos criterios.'}
          </p>
        </Card>
      )}
    </div>
